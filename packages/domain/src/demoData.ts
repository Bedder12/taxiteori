...
function createQuestion(index: number, lessonId: string): QuestionVersion {
  ...
  return {
    ...
    sourceIds: ['source_placeholder_curriculum'],
    requirementKeys: ['DEMO-VILOTIDER-001'],
    factKeys: ['DEMO-VILOTIDER-FACT-001'],
    sourceReferences: [{ sourceId: 'source_placeholder_curriculum', exactReference: 'Demo placeholder source reference' }],
    status: 'published',
    createdAt: now,
    reviewedAt: now,
  };
